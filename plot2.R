...
groupedByYear <- group_by(baltimoreData, year)
...
title(main = "PM2.5 Emission totals in Baltimore City, Maryland from 1999 to 2008")

# Export as PNG

print("Exporting the plot as a PNG")

dev.copy(png, file = "plot2.png", height=480, width=760)
dev.off()
